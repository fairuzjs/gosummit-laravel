                    ...
                    <tr class="hover:bg-gradient-to-r hover:from-purple-50 hover:to-blue-50 transition-all duration-200">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <form action="{{ route('admin.notifications.destroy', $notification) }}" method="POST" class="inline-block">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="inline-flex items-center px-3 py-1.5 bg-gradient-to-r from-red-500 to-red-600 text-white font-bold rounded-lg hover:shadow-lg transform hover:scale-[1.02] transition-all duration-200" onclick="return confirmAction('Are you sure you want to delete this notification?', this.closest('form'))">
                ...
                <div class="px-4 py-3 bg-gray-50 border-t border-gray-200">
                    <form action="{{ route('admin.notifications.destroy', $notification) }}" method="POST">
                        ...
                        <button type="submit" 
                                ...
                                onclick="return confirmAction('Are you sure you want to delete this notification?', this.closest('form'))">
