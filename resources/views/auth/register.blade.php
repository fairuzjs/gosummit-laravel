    ...
    <div class="auth-container">
        ...
        <div class="welcome-section">
            ...
            <div class="welcome-content">
                ...
                <p>{{ __('Create your account to connected with us') }}</p>
        ...
        <div class="form-section">
            ...
            <div class="social-login">
                <div class="social-buttons">
                    <a href="#" class="social-btn" title="Continue with Facebook" aria-label="Sign up with Facebook">
                        <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                        </svg>
                    </a>
                    <a href="{{ route('auth.google') }}" class="social-btn" title="Continue with Google" aria-label="Sign up with Google">
                    ...
                    <a href="#" class="social-btn" title="Continue with LinkedIn" aria-label="Sign up with LinkedIn">
            ...
            <div class="divider">
                <span>{{ __('or register with email') }}</span>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}" id="registerForm">
                ...
                <div class="form-group">
                    ...
                    />
                    @error('name')
                        <span class="error-message" id="name-error" role="alert">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    @error('password_confirmation')
                        <span class="error-message" id="password-confirmation-error" role="alert">{{ $message }}</span>
                    @enderror
                </div>

                <div class="terms-group">
                    {{ __('By signing up, you agree to our') }} <a href="{{ url('/terms-of-service') }}">{{ __('Terms of Service') }}</a> {{ __('and') }} <a href="{{ url('/privacy-policy') }}">{{ __('Privacy Policy') }}</a>
                </div>
