...
class StoreMountainRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'trail_routes' => 'nullable|array',
            'trail_routes.*.name' => 'required_with:trail_routes|string|max:255',
            'trail_routes.*.description' => 'nullable|string',
            'trail_routes.*.status' => 'required_with:trail_routes|in:open,closed',
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'trail_routes.*.name.required_with' => 'Nama jalur pendakian wajib diisi.',
            'trail_routes.*.status.in' => 'Status jalur harus open atau closed.',
        ];
    }
}
